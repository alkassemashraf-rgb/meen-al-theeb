...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,roundId,questionId,questionAr,questionEn,packId,phase,startedAt,expiresAt,const DeepCollectionEquality().hash(eligiblePlayerIds),const DeepCollectionEquality().hash(votes),result);

@override
String toString() {
  return 'GameRound(roundId: $roundId, questionId: $questionId, questionAr: $questionAr, questionEn: $questionEn, packId: $packId, phase: $phase, startedAt: $startedAt, expiresAt: $expiresAt, eligiblePlayerIds: $eligiblePlayerIds, votes: $votes, result: $result)';
}
...
@useResult
$Res call({
 String roundId, String questionId, String questionAr, String questionEn, String packId, String phase, DateTime startedAt, DateTime expiresAt, List<String> eligiblePlayerIds, Map<String, String> votes, RoundResult? result
});
...
/// Create a copy of GameRound
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? roundId = null,Object? questionId = null,Object? questionAr = null,Object? questionEn = null,Object? packId = null,Object? phase = null,Object? startedAt = null,Object? expiresAt = null,Object? eligiblePlayerIds = null,Object? votes = null,Object? result = freezed,}) {
...
switch (_that) {
case _GameRound() when $default != null:
return $default(_that.roundId,_that.questionId,_that.questionAr,_that.questionEn,_that.packId,_that.phase,_that.startedAt,_that.expiresAt,_that.eligiblePlayerIds,_that.votes,_that.result);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String roundId,  String questionId,  String questionAr,  String questionEn,  String packId,  String phase,  DateTime startedAt,  DateTime expiresAt,  List<String> eligiblePlayerIds,  Map<String, String> votes,  RoundResult? result)  $default,) {final _that = this;
switch (_that) {
case _GameRound():
return $default(_that.roundId,_that.questionId,_that.questionAr,_that.questionEn,_that.packId,_that.phase,_that.startedAt,_that.expiresAt,_that.eligiblePlayerIds,_that.votes,_that.result);case _:
  throw StateError('Unexpected subclass');
...
class _GameRound implements GameRound {
  const _GameRound({required this.roundId, required this.questionId, required this.questionAr, required this.questionEn, this.packId = '', required this.phase, required this.startedAt, required this.expiresAt, final  List<String> eligiblePlayerIds = const [], final  Map<String, String> votes = const {}, this.result}): _eligiblePlayerIds = eligiblePlayerIds,_votes = votes;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,roundId,questionId,questionAr,questionEn,packId,phase,startedAt,expiresAt,const DeepCollectionEquality().hash(_eligiblePlayerIds),const DeepCollectionEquality().hash(_votes),result);
...
/// Create a copy of GameRound
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? roundId = null,Object? questionId = null,Object? questionAr = null,Object? questionEn = null,Object? packId = null,Object? phase = null,Object? startedAt = null,Object? expiresAt = null,Object? eligiblePlayerIds = null,Object? votes = null,Object? result = freezed,}) {
